...
return [
    ...
    'title' => 'ElePHPant.me API',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'A free, public JSON API for the PHP community.',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<'INTRO'
        Everything here is public, read-only and needs no API key. Herds marked private by their
        owner are excluded from every endpoint.

        The machine-readable spec lives at [/openapi.yaml](/openapi.yaml). Country codes are
    ...
    'routes' => [
        [
            ...
            'exclude' => [
                // Requires Passport auth and isn't part of the public read-only JSON API.
                'GET /api/user',
            ],
        ],
    ],
    ...
    'openapi' => [
        ...
        'overrides' => [
            'info.license' => [
                'name' => 'MIT',
                'url'  => 'https://github.com/jgrossi/elephpant.me/blob/master/LICENSE',
            ],
        ],
