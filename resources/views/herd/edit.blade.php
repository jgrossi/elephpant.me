    ...
    <div class="main">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>My Herd</h1>
                    <p>Which (and how many) elePHPants do you have?</p>
                </div>
            </div>
        </div>
    </div>
                                                    ...
                                                    <div class="media">
                                                        ...
                                                        >
                                                            <img
                                                                ...
                                                                width="50" alt=""
                                                                class="img-thumbnail rounded img-fluid mr-3">
                                                        </a>
                                                        <div class="media-body">
                                                            <p class="mb-0"><strong>{{ $elephpant->name }}</strong>
                                                                - {{ $elephpant->description }}</p>
