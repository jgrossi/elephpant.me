...
<body>
    <div id="app">
        ...
        <footer class="mt-4 text-center py-4 bg-white border-top">
            <p class="mb-2">
                Made with ❤️ by <a href="http://twitter.com/junior_grossi" target="_blank">Junior Grossi</a> and <a href="http://twitter.com/IgorSantoos17" target="_blank">Igor Santos</a>.
