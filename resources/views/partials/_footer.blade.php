            ...
            <div class="grid grid-cols-2 gap-8 sm:grid-cols-4">
                ...
                <div>
                    ...
                    <ul class="mt-3 space-y-2 text-sm">
                        ...
                        <li><a href="https://discord.gg/dAcA4WFBjD" target="_blank" rel="noopener noreferrer" class="text-violet-200/85 transition hover:text-white">Join the Discord Server</a></li>
                    </ul>
                </div>
            </div>
        </div>
