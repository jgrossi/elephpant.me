    ...
    <div class="main">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>Trade Area</h1>
                    <p>Looking for new elePHPants? Take a look on these possibilities.</p>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div data-controller="ping" data-ping-id="{{ $user->id }}">
                                        <div class="message-box alert alert-success mb-0" style="display: none;">
                                        ...
                                        <div class="form-box">
                                            <div class="form-group">
                                                <textarea
                                                    ...
                                                    class="form-control"
                                                    rows="2"
                                                    placeholder="Hey, just saw you're looking for an elePHPant I have double. Let's trade?"
                                                    data-target="ping.message"></textarea>
                                            </div>
                                            <button type="submit" class="btn btn-primary" data-action="ping#send">
